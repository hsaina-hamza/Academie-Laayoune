...
const ProjectForm = () => {
  ...
  const handleFileChange = (e) => { setFormData({ projectImage: e.target.files[0], });};
...
<div className="">
  ...
  <div className="row justify-content-center">
    <div className="col-md-8">
      ...
      <form onSubmit={handleSubmit} className="p-4 border rounded bg-white sha">
        ...
        <div className="form-group mb-3">
          ...
          <input type="date" className="form-control form-control-lg" name="endDate" value={formData.endDate} onChange={handleChange} requ />
        </div>
